...
def build_notification_content(candidate, status):
    ...
    stage_messages = {
        ...
        'screening': (
            ...
            "我们希望通过一次更直接的交流，了解你对业务 AI 重构、CTO助理角色以及真实组织问题的思考方式。相比标准答案，我们更重视你是否能提出有判断、有结构、有行动感的想法。\n\n"
        ...
        'offer': (
            ...
            "在前面的沟通和评估中，我们看到了你参与业务 AI 重构项目的潜力，也期待你以CTO助理的角色进入真实业务场景，参与问题识别、方案设计和落地推进。\n\n"
